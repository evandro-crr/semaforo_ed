#ifndef CRIANCACHINESA_HPP
#define CRIANCACHINESA_HPP
...
class CriancaChinesa {
public:
    CriancaChinesa(Oraculo &O, Pista &P, unsigned int frequencia, unsigned int variacao, std::string saida) :
